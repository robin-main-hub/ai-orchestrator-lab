...
// Thin Anthropic-specific wrapper around the shared
// baseProviderRequest — only the ids that need to look "Anthropic-ish"
// for log readability are overridden; the rest defaults to the
