...
origin/main @ `55c8716` (`#174` docs merge, Stage 1b 기준 마지막 UI merge = `#192`). R4 v0 cascade train + R5 Stage 1b primitive adoption 1차/2차/3차 wave 완료 (2026-05-27 sync; 후속 `#156`~`#192`, scripts-only `#164`, docs-only `#174`). 아래 R4-era open PR 표와 "Stage 1b 진행 중" 표현은 이 섹션이 최신 기준으로 supersede한다.
