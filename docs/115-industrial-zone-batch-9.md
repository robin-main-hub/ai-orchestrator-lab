...
## 한 줄 요약
generic OS 이벤트를 읽을 수 있는 범주(failure/learning/runner/approval/memory/project/system)로 분류하고, Today/Recent 배지·REPLAY 필터·WorkItem-lite 행으로 의미를 입혔다. ERP/domain 도메인 0. SANDBOX 계속 보류.
...
## 안전 불변식 (0 유지)
```text
ERP/domain import 0 · fake live 0 · external send 0
