...
## Purpose
This document defines the REST payload contract and architecture for transferring aggregated non-ERP signals (Evidence) from the `example-erp-v1` Evidence Hub to the `ai-orchestrator-lab` Memory/Learning Loop.

## Architecture
1. **Source (Sender)**: `example-erp-v1`
