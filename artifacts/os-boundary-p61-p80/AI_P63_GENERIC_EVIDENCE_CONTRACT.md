...
## Context
The AI Orchestrator OS boundary requires that the core evidence ingestion mechanism be entirely agnostic to any specific domain (such as ERP, CRM, or GIOLITE concepts). The evidence ingested should act purely as generic knowledge vectors for the AI system.
...
Plugins (like the GIOLITE ERP Plugin) will map their domain-specific payload to this generic contract.
