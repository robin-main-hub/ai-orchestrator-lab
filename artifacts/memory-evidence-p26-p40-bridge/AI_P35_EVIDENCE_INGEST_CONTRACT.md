...
This contract defines how `ai-orchestrator-lab` will map the JSON artifact exported from `example-erp-v1` into native Memory objects for the AI Agent context.
