...
## Objective
Validate the full end-to-end flow of signals generated in `gio-erp-v1` being ingested by `ai-orchestrator-lab` memory and correctly surfaced during agent recalls.

## Steps

### Phase 1: GIO ERP Generation
1. Connect to DGX-02 `gio-erp-v1` environment.
